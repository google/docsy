...
* **GitHub**: Get in-page links directly to your [GitHub repo](https://github.com) and provide your users with a
   convenient pathway to providing feedback, opening issues, and even suggesting changes through Pull Requests.
* **Google Analytics**: Easily connect your [Google Analytics](https://analytics.google.com/analytics/web/) account to your 
   site.
* **Google Custom Search**: Use [Google Custom Search](https://cse.google.com/cse/) for in-site search queries, or 
...
[apply Docsy updates](/docs/updating/) to your site, as well as open feature requests to improve the 
template, or even add new behaviors.

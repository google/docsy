// The migration ratchet shared by the two framework-class nets: the
// literal-token lint (../framework-classes.test.mjs) gates these partials'
// template text, and the rendered-output net

...
| `09a5d40d` | [#2565][] | Update doc-rooted configs to avoid root index render clash  | [#2504][]                       | PR body                                | `card` now uses `$.Page.RenderString`                |
...
| `500ee239` | [#2586][] | Update version+variant menu, add `siteGetPage`, `tdVersion` | [#2504][]                       | PR body                                | Not client-facing for release notes                  |

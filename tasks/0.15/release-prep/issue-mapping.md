...
| PR        | Title                                                       | Linked issue or tracker         | Source                                 | Notes                                                |
| --------- | ----------------------------------------------------------- | ------------------------------- | -------------------------------------- | ---------------------------------------------------- |
| [#2555][] | Set version to 0.14.3-dev                                   | [#2501][]                       | Release prep scope                     | Maintenance after 0.14.3                             |
| [#2556][] | Reorg deployment docs, normalize links                      | None found                      | PR body                                | Docs-only cleanup                                    |
| [#2557][] | Add version menu to site, improve version partial           | None found                      | PR body                                | User-facing site/version menu work                   |
| [#2558][] | Replace bogus placeholder locale by fr                      | None found                      | PR body                                | Site i18n setup                                      |
| [#2559][] | Document new `deploy/prod` branch                           | None found                      | PR metadata                            | Release-process docs                                 |
| [#2560][] | Update bug report template                                  | None found                      | PR metadata                            | Admin                                                |
...
| [#2567][] | Remove `sidebar_root_for` user-guide docs                   | None found                      | PR body                                | Follow-up docs cleanup                               |
...
| [#2572][] | Clarify release process and branch model                    | None found                      | PR metadata                            | Release-process docs                                 |
...
| [#2575][] | Format project about docs and add project link              | None found                      | PR metadata                            | Docs cleanup                                         |
...
| [#2584][] | Add markdownlint rule for no site-local external URLs       | None found                      | PR body                                | Link hygiene                                         |
| [#2585][] | Update NPM packages, Hugo to 0.157.0, drop `cpy-cli`        | None found                      | PR body, dependency label              | Dependency/tooling bundle                            |
...
| [#2082][] | Add Azerbaijan language                                     | None found                      | PR metadata                            | Locale contribution                                  |
...
| [#2591][] | Add missing German alert label translations                 | None found                      | PR body                                | i18n fix                                             |

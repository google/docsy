---
title: Zendesk US Government without contributions
description: Support Operations policies page for project setup for Zendesk US Government without support contributions
canonical_path: "/handbook/support/readiness/operations/docs/policies/project_setup/zendesk_usgov_without"
---

For projects involving Zendesk US Government that do not enable support
contributions, the only real tasks are building the core project itself.

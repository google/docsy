...
- Please use the correct member statuses based on the definitions and type [here](https://handbook.gitlab.com/handbook/marketing/marketing-operations/campaigns-and-programs/#campaign-type--progression-status). They must be exact matches, no abbreviations.
...
- Record ownership will be assigned using established lead routing, which is [controlled by Traction Complete](https://handbook.gitlab.com/handbook/marketing/marketing-operations/traction-lead-complete/)
...
1. Remove all [embargoed country](https://handbook.gitlab.com/handbook/legal/trade-compliance/) records.
...
1. Member Statuses must match exactly to the program type and member status [listed](https://handbook.gitlab.com/handbook/marketing/marketing-operations/campaigns-and-programs/#campaign-type--progression-status).
...
With a record marked as `Follow Up Requested`, this will score the record with 100pts, as [noted here](https://handbook.gitlab.com/handbook/marketing/marketing-operations/marketo/#behavior-scoring), which will then in turn show up in the [Sales Dev’s team P1 (Priority 1) view](https://handbook.gitlab.com/handbook/marketing/sales-development/#bdr-event-promotion-and-sales-dev-org-follow-up). The Sales Dev team is happy to have potential unrelevant records routed to them in an effort to speed up the records getting to them.
...
If this import is part of a Channel or Alliance marketing campaign, you must include the `CRM Partner ID` as a column in your list upload. You can find a list of these IDs [here](https://handbook.gitlab.com/handbook/marketing/marketing-operations/campaigns-and-programs/#crm-partner-id)
If the lead is not associated to a partner, leave that field blank.
### Campaign Templates - Info for Post-MktgOps Hand-off
At time of upload, a campaign should already exist in `Marketo` . Campaigns are to be created by the campaign owner. For a running list of campaign templates, go [here](https://handbook.gitlab.com/handbook/marketing/marketing-operations/campaigns-and-programs/#how-to-clone-the-marketo-program).
### Upload Process

...
6.  <a id="ci-test-step">Run `npm run test:full`</a>, which runs
    `_test:full:pre` and more to ensure that, e.g., vendor assets and [go.mod][]
    dependencies are up-to-date, etc.

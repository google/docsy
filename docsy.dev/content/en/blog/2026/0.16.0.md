...
For the generic update steps (Docsy theme, Node, Hugo), follow
[Update Docsy][], which reflects the install paths introduced by this release's
[theme folder move](#theme-folder-actions); apply that section's config changes
as part of the update. For this release, use:[^vers-note]
...
- [ ] If your site overrides theme files, [update your theme
      overrides][overrides]: diff each override against the new theme version
      and port upstream changes.
...
[overrides]: /docs/updating/#update-overrides
[Update Docsy]: /docs/updating/
<!-- prettier-ignore-end -->

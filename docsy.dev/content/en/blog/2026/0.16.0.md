...
which reflects the install paths introduced by this release's [theme folder
move](#theme-folder-actions); apply that section's config changes as part of
the update. For this release, use:[^vers-note]

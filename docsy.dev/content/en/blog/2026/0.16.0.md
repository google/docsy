...
- If your site [overrides theme files][overrides], diff each override against
...
For the generic update steps (Docsy package, Hugo, Node), follow
...
[overrides]: /docs/content/lookandfeel/

...
- {{% _param BREAKING %}} Rename `td-offset-anchor` to
  ...
  notes][heading-aliases-impl-notes]. Applies if your site used the old class
  name. This can happen if you override `blocks/lead.html`,
...
Applies if your site uses the [blocks/cover] shortcode.

### Actions: required and optional {#blocks-cover-actions}

- Using [blocks/cover] with Markdown content? Call it with Hugo's shortcode
  [Markdown call syntax][]: `{{%/* */%}}`, otherwise it might not render content
  correctly.

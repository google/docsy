...
Navbar **height and styling** are tunable via ({{%_param BADGE
EXPERIMENTAL info %}}):
...
Learn more about the default [Navbar][] appearance and [Customizing the
navbar][].
...
[sidebar.html]:
  <{{% param github_repo %}}/blob/main/layouts/_partials/sidebar.html?plain=1>
[sidebar-tree.html]:
  <{{% param github_repo %}}/blob/main/layouts/_partials/sidebar-tree.html?plain=1>
[blocks/cover.html]:
  <{{% param github_repo %}}/blob/main/layouts/_shortcodes/blocks/cover.html?plain=1>
[blocks/lead.html]:
...
[pageinfo.html]:
  <{{% param github_repo %}}/blob/main/layouts/_shortcodes/pageinfo.html?plain=1>
[site-build-info-netlify.md]:
  <{{% param github_repo %}}/blob/main/layouts/_shortcodes/td/site-build-info/netlify.md?plain=1>
[blog/baseof.html]:
  <{{% param github_repo %}}/blob/main/layouts/blog/baseof.html?plain=1>
[community/list.html]:
  <{{% param github_repo %}}/blob/main/layouts/community/list.html?plain=1>
[docs/baseof.html]:
  <{{% param github_repo %}}/blob/main/layouts/docs/baseof.html?plain=1>
[swagger/baseof.html]:
  <{{% param github_repo %}}/blob/main/layouts/swagger/baseof.html?plain=1>

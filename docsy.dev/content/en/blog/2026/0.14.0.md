...
cSpell:ignore: docsy gohugoio subrepo lightdark lookandfeel
---
...
- {{% _param FA_LG book info %}} <span>**Content and localization**: new
  ...
  [internationalization](#other-notable-changes) improvements.
...
- **Content and shortcodes**:
  ...
  - [blocks/cover](#blocks-cover) changes
...
- **[Public vs internal features](#clarified-public-vs-internal-theme-features)**:
  - Definitions for customization surface, private/internal, and support limits
...
navbar, [internal] SCSS file reorganization and it's impact on Swagger UI
customization.
...
- **Navbar over cover images** style fixes and translucency behavior
  improvements.
...
> [!TIP] :bulb: Pro Tip — reducing technical debt!
>
> If your project customizes navbar and other Docsy styles, review your
> customizations to use the newly introduced SCSS and CSS variables and styles.
> This will likely simplify your overrides and reduce [technical debt][]!
...
> [!NB] [Upgrade to Docsy 0.13.0][] if you haven't already.
...
After upgrading, ensure that you are aware of and have addressed
[breaking changes](#breaking-changes), and test your site thoroughly. Pay

...
- {{% _param FAS_LG thumbtack warning %}}
  <span>**[Pinned script versions](#script-dep-pins)**: Mermaid, KaTeX, and
  markmap no longer resolve from the CDN's `latest`</span>
...
- **Install and defaults**:
  ...
  - [Default script-dependency versions pinned](#script-dep-pins): Mermaid,
    KaTeX, and markmap no longer resolve from the CDN's `latest`

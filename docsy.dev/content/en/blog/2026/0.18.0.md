...
- **No action needed** if none of the cases below applies. One residual: pages
  in the opt-in `print` output no longer load tab persistence or
  registry-enabled MarkMap (page-gated scripts never reached print output;

...
- **If you produce MarkMap markup other than through a `markmap` fence** (raw
  HTML, your own render hook or shortcode, Docsy's `tab` or `readfile`
  shortcodes with `lang=markmap`), the page-gated script no longer sees it: set

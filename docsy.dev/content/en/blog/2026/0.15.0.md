...
- {{% _param FAS_LG triangle-exclamation warning %}}
  <span>**[Action review](#ready-to-upgrade)**: community/footer link paths and
  `card` shortcode rendering</span>
...
- [Agent support](/docs/content/agent-support/) user guide for opt-in Markdown
  output, `llms.txt`, and related checks ([#2596][], [#2597][]).

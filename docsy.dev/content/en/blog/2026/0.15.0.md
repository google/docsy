...
- {{% _param FAS_LG robot info %}}
  <span>**[Agent-friendly docs](#agent-friendly)** (AFDocs): `llms.txt`,
...
- **[Agent-friendly docs (AFDocs)](#agent-friendly)**
...
## {{% _param NEW %}} Agent-friendly docs (AFDocs) {#agent-friendly}
...
For details, see [Agent-friendly docs support][].

[Agent-friendly docs support]: /docs/content/agent-support/

...
updated: 2024-12-12
# prettier-ignore
cSpell:ignore: subdir sarahmaddox jmooring
---
...
easier customization, are planned for the next [major release][#1812]
([#1852][]).
...
For the complete list of changes in this release, see the [0.9.0][] release
entry and issue

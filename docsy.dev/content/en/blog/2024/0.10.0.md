...
As a validation of this upgrade, Docsy has been enhanced to support [dark
mode][], the _most upvoted_ Docsy enhancement request ([#331][]) prior to this
release.

To learn how to enable a **light/dark mode dropdown menu** for your project, see
[Light/dark mode menu][]. We have enabled this menu for the Docsy [User
Guide][], so if you're reading this post online, give dark mode a try!

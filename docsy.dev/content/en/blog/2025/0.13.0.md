...
- {{% _param FAS_LG fire warning %}} <span>Docsy [0.13.0][] includes the
  **_[most upvoted][]_ enhancement** [request of 2025][], and more.</span>
...
feature is implemented using (a [patched][] version of) Bootstrap’s
[ScrollSpy][]. The new default TOC labels “On this page” and “Top of page” are
localizable. For details, see [Active TOC entry tracking with ScrollSpy][].
...
- {{% _param FAS palette info %}} **Color contrast** improvements for dark mode:
  ...
  - Early experimental support for customizable color-contrast adjustments for
    projects using Bootstrap's theme variables ([#2384][]). For details, see

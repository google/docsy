...
> [!IMPORTANT]
>
> The commands below are for upgrades **to Docsy 0.12 (this post), [0.13][],
> [0.14][], or [0.15][]**. As of [0.16.0][], the theme's install paths changed;
> for current update commands, see [Update Docsy](/docs/updating/).

[0.13]: /blog/2025/0.13.0/
[0.14]: /blog/2026/0.14.0/

...
submodules also lets Hugo use the theme files from the Docsy repo, though is more
...
To clone Docsy at v{{% param version %}} into your project's `themes` folder, run
